...
SilphCo11F_Object:
	...
	object_event  5, 14, SPRITE_ROCKET, STAY, DOWN, TEXT_SILPHCO11F_ROCKET1, OPP_ROCKET, 40
	object_event  4, 14, SPRITE_ROCKET, STAY, DOWN, TEXT_SILPHCO11F_ROCKET2, OPP_ROCKET, 41
